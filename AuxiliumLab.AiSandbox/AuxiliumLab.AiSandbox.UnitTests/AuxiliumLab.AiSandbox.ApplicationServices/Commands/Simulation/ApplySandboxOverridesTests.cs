...
public class CreateFromValuesTests
{
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 5, 2, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 25, 20, 10, 5, 2, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 30, 10, 5, 2, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 15, 5, 2, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 8, 2, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 5, 4, 5, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 5, 2, 9, 15, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 5, 2, 5, 25, 1);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10, 5, 2, 5, 15, 3);
    ...
    {
        var config = SandBoxConfiguration.CreateFromValues(50, 20, 20, 10.99, 5, 2, 5, 15, 1);
        config.MapSettings.ElementsPercentages.BlocksPercent.Current.Should().Be(10);
    }
}
